...
Follow the common mutation, confirmation, idempotency and unknown-outcome contract in `charline-workspace`. Drive-specific preview fields are account, parent folder ID, name, MIME intent, source path and effect. Verify the returned file ID and compare name, type and parent where exposed.
